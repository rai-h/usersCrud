...
class EditUserScreen extends StatefulWidget {
  ...
  const EditUserScreen({Key? key, required this.userModel}) : super(key: key);
...
class _EditUserScreenState extends State<EditUserScreen> {
  ...
  void initState() {
    ...
    _gender =
        widget.userModel.gender! == 'male' ? Constants.MALE : Constants.FEMALE;
    _activeStatus = widget.userModel.status!;
